...
var CartoDbLib = {
  ...
  layerUrl: 'https://datamade.carto.com/api/v2/viz/b176507c-078f-4070-bc11-8d97cc880e7a/viz.json',
  tableName: 'probationresourcesmap_mergeddata_resourceslive_probationresou_1',
  userName: 'datamade',
  geoSearch: '',
  whereClause: '',
  ageSelections: '',
  ...
  modalPop: function(data) {
      ...
      if (data.umbrella_organization_created != '')
        modal_title += data.umbrella_organization_created + " - ";
  ...
  formatText: function(text) {
    ...
    capitalText = capitalText.replace(/Column/g, '')
